...
class FirebaseUserRepo implements MyUserRepo {
  ...
  @override
  Future<Either<Success<String>, Failure>> logIn(MyUser myUser, String password) async {
    try {
  ...
  @override
  Future<Either<Success<MyUser>, Failure>> signUp(MyUser myUser, String password) async {
    try {
